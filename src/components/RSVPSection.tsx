        ...
        {step === 'form' && (
          <form onSubmit={handleConfirmRSVP} className="space-y-6 font-sans">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-6 w-full bg-gold-soft text-night text-[18px] uppercase tracking-[0.2em] py-4 rounded-sm hover:bg-gold transition-colors flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 shadow-sm"
            >
              {loading ? (
                <>
